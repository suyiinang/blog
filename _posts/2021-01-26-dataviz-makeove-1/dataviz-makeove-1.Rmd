...
```{r, fig.cap = "Chart 6 of Labour Force in Singapore 2019 report (page 22)", out.width = "100%"}
...
```{r, fig.cap = "Pivot data", out.width = "100%"}
...
```{r, fig.cap = "Create flat file", out.width = "100%"}
...
```{r, fig.cap = "Change data type", out.width = "100%"}
...
```{r, fig.cap = "Apply colour", out.width = "50%"}
...
```{r, fig.cap = "Create new age band group", out.width = "100%"}
...
```{r, fig.cap = "Create stacked bar chart", out.width = "100%"}
