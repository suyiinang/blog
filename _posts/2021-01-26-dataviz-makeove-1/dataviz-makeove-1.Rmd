...
|3   | **Axis title not properly labeled** – ‘Share of labour force' was not labeled on the y axis. This leaves room for misinterpretation and/or requires reader’s extra time to peruse the chart, all of which draws attention away from the main message. | It would be clearer and more quickly understood to the reader if both the **y-axis** was **appropriately labeled**. |
:::
